...
export default function ErrorBanner({ message, onRetry }) {
  return (
    <div style={{ padding: '32px 16px', textAlign: 'center' }}>
      <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--danger-bg)', border: '1px solid var(--danger-border)', borderRadius: 6, padding: '12px 16px', marginBottom: 12 }}>
        ...
        <span style={{ fontSize: 13, color: 'var(--danger)', fontWeight: 500 }}>{message}</span>
      </div>
      <br />
