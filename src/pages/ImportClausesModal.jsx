...
import { importClausulasExcel } from '../api';
...
export default function ImportClausesModal({ onClose, onSuccess }) {
  ...
  const handleConfirm = async () => {
    ...
    setError(null);
    try {
      const resultado = await importClausulasExcel(file);
      onSuccess(resultado);
    } catch (err) {
    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: 16, fontWeight: 700, color: 'var(--text-primary)' }}>Importar cláusulas</h2>
